const BASE = (process.env.REACT_APP_API_BASE || 'http://localhost:5001/api') + '/akshara';
...
// Available if a Leaderboard screen is added in future:
// export async function submitLeaderboard(data) { ... }
// export async function getLeaderboard(language) { ... }
