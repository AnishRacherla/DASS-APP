...
// DEVELOPMENT - Local testing (replace with your IP), can override via EXPO_PUBLIC_API_BASE_URL
const API_BASE_URL = process.env.EXPO_PUBLIC_API_BASE_URL || 'http://10.2.143.103:5001';
